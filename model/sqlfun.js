...
var sqlMap = {
  wishList: {
    ...
    insertShareList  : "INSERT INTO t_share_list ( `title`, `desc`, `url`, `product_id`, price, img_url) VALUES (?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE `desc`=VALUES(`desc`), price=VALUES(price), title=VALUES(title), img_url=VALUES(img_url)",
